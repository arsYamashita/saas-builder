...
// scripts/preflight-env.ts is the deploy-time replacement for making
// Upstash required at import time (see lib/rate-limit.ts's lazy,
// fail-closed-in-production design). It must be run as an explicit
// pipeline step before go-live, never at import time.
