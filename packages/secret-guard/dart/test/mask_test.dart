...
void main() {
  ...
  test('masks a bare token= assignment with an opaque non-hex value', () {
  ...
  test('masks a token: (colon) assignment with an opaque non-hex value', () {
  ...
  test('does NOT false-match compound words like tokenizer=', () {
