...
# Compare a regression run against the reservation_saas GREEN v1 baseline
# Usage: bash scripts/compare-rsv-baseline.sh <project-id>
...
BASELINE_JSON="tests/baselines/reservation-saas-green-v1.json"
