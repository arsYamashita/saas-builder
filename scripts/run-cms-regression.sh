...
# community_membership_saas regression test runner
...
FIXTURE="tests/fixtures/community-membership-saas-first-run.json"
POLL_INTERVAL=10
MAX_POLLS=60

echo "=== CMS Regression Test ==="
...
bash "$SCRIPT_DIR/compare-cms-baseline.sh" "$PROJECT_ID"
