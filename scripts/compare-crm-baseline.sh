...
# Compare a regression run against the simple_crm_saas GREEN v1 baseline
# Usage: bash scripts/compare-crm-baseline.sh <project-id>
...
BASELINE_JSON="tests/baselines/simple-crm-green-v1.json"
