...
# internal_admin_ops_saas regression test runner
...
FIXTURE="tests/fixtures/internal-admin-ops-first-run.json"
POLL_INTERVAL=10
MAX_POLLS=60

echo "=== IAO Regression Test ==="
...
bash "$SCRIPT_DIR/compare-iao-baseline.sh" "$PROJECT_ID"
